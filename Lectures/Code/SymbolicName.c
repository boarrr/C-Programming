...
int main(void)
{
  ...
  // Let's find the highest and lowest age entered
 	...
 	/* 
    This loop is used to go through each number in the array and check if it is higher than the variable highest and lower than the variable lower. 
    If so, it replaces the values in highest and lowest
 	*/
 	for(i = 0; i < SIZE; i++)
 	{
